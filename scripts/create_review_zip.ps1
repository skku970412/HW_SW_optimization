...
$files = @(
    ...
    "results/dse_autotune.csv",
    "results/dse_autotune_best.json",
    "results/dse_autotune.md",
    "results/dse_pareto.csv",
    "results/model_calibration.csv",
    "results/model_calibration.json",
    "results/model_calibration.md",
